...
<div class="panel-card">
    ...
    <div class="panel-card-body">
        <textarea name="privacy_policy" rows="12" class="form-control" placeholder="Write the privacy policy shown to clients...">{{ old('privacy_policy', $setting->privacy_policy) }}</textarea>
    </div>
</div>
