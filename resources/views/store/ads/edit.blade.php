    ...
    <div class="panel-card-body">
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input type="datetime-local" name="start_at" value="{{ old('start_at', optional($ad->start_at)->format('Y-m-d\TH:i')) }}" class="form-control">
                <div class="form-text">Leave empty for a link that's available right away.</div>
            </div>
            <div class="col-md-6">
                <label class="form-label">Ends at</label>
                <input type="datetime-local" name="expires_at" value="{{ old('expires_at', optional($ad->expires_at)->format('Y-m-d\TH:i')) }}" class="form-control">
