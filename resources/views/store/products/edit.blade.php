    ...
    <div class="panel-card-body">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="number" step="0.01" min="0" name="price_usd" value="{{ old('price_usd', $product->price_usd) }}" class="form-control" required>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="panel-card-body">
        <div class="row g-3">
            <div class="col-md-4">
                ...
                <input type="number" step="0.01" min="0" max="100" name="discount_percent" value="{{ old('discount_percent', $product->discount_percent) }}" class="form-control">
            </div>
            <div class="col-md-4">
